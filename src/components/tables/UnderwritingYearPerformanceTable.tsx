              ...
              {allData.map((row, index) => (
                ...
                >
                  ...
                  <TableCell className="text-right">
                    {formatKDNumeric(row.premium)}
                  </TableCell>
                  <TableCell className="text-right">
                    {formatKDNumeric(row.paidClaims)}
                  </TableCell>
                  <TableCell className="text-right">
                    {formatKDNumeric(row.outstandingClaims)}
                  </TableCell>
                  <TableCell className="text-right">
                    {formatKDNumeric(row.incurredClaims)}
                  </TableCell>
                  <TableCell className="text-right">
                    {formatKDNumeric(row.expense)}
                  </TableCell>
                  <TableCell className="text-right">
                    <span className={`${
                  ...
                  <TableCell className="text-right">
                    {formatKDNumeric(row.avgMaxLiability)}
                  </TableCell>
                </motion.tr>
              ))}
            </TableBody>
